package com.kakao.kakaogift.activity.mine.pin.adapter;
...
import com.kakao.kakaogift.activity.mine.pin.MyPingouDetailActivity;
...
public class MyPinTuanAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			convertView = inflater
					.inflate(R.layout.my_pingou_item_layout, null);
		...
		GlideLoaderTools.loadSquareImage(mContext, goods.getPinImg().getUrl(),
				holder.img);
	...
	private class ViewHolder {
		...
		public ViewHolder(View convertView) {
			...
			this.see_order = (TextView) convertView
					.findViewById(R.id.see_order);
		}

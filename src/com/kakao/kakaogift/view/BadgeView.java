...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_TEXT_COLOR =  Color.parseColor("#1DA8A5");
...
//		setPadding(paddingPixels, paddingPixels, paddingPixels, paddingPixels);
	...
	private void applyLayoutParams() {
		...
		case POSITION_TOP_RIGHT:
			...
			lp.setMargins(0, dipToPixels(2), dipToPixels(40), 0);
			break;
		...
		case POSITION_CENTER_HORIZONTAL:
			...
			lp.setMargins(dipToPixels(10), dipToPixels(6), 0, 0);
			break;

...
public class FolderAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if(view == null){
            view = mInflater.inflate(R.layout.gallery_list_item_folder, viewGroup, false);
            ...
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    Glide.with(mContext)
                            ...
                            .error(R.drawable.gallery_default_error)
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            if (data.cover != null) {
                 ...
                 .placeholder(R.drawable.gallery_default_error)
                 .centerCrop()
                 .into(cover);
            }else{
                cover.setImageResource(R.drawable.gallery_default_error);
            }
        }
    }

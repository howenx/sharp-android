...
public class DrawerToast {
	...
	private void initView() {
		...
		mTopView2.setGravity(Gravity.TOP);
		mTopView2.setPadding(0, CommonUtil.getStatusBarHeight(mContext)
				+mContext.getResources().getDimensionPixelSize(R.dimen.actionbar_size), 0, 0);
...
//		mView.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.TOP);
	...
	public void showByAnim(String msg, Long duration){
		show(msg, duration, startAnimation1(), endAnimation1());
	}
	...
	public AnimationSet startAnimation1() {
		TranslateAnimation animTrans = new TranslateAnimation(
				Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT,
		...
		startAnim.addAnimation(animTrans);
		startAnim.addAnimation(animAlpha);
		return startAnim;
	}
	public AnimationSet endAnimation1() {
		TranslateAnimation animTrans = new TranslateAnimation(
				Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT,
		...
		endAnim.addAnimation(animAlpha);
		return endAnim;
	}
}
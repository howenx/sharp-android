...
public class DragImageView extends ImageView {
	...
	private void initView(Context context) {
		...
		this.screen_H = mActivity.getWindowManager().getDefaultDisplay()
				.getHeight();
		this.screen_W = mActivity.getWindowManager().getDefaultDisplay()
				.getWidth();
	}
...
//		mDoubleClickListener.OnDoubleClick();
	...
	public void setOnDoubleClickListener(OnDoubleClickListener mDoubleClickListener) {

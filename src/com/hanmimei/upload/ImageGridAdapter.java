...
import com.hanmimei.upload.BitmapCache.ImageCallback;
...
public class ImageGridAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			holder = new Holder();
			convertView = View.inflate(act, R.layout.upload_item_image_grid, null);
		...
		if (item.isSelected) {
			...
			holder.text.setBackgroundResource(R.drawable.upload_bgd_relatly_line);
		} else {

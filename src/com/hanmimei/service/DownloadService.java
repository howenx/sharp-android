	...
	private Handler mHandler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case DOWNLOAD_SUCCESS:
				...
				ToastUtils.Toast(DownloadService.this, "下载完成");
				break;
			case URL_ERROR:
				ToastUtils.Toast(DownloadService.this, "下载地址错误");
				break;
			case NET_ERROR:
				ToastUtils.Toast(DownloadService.this, "连接失败，请检查网络设置");
				break;
			}
		};
	};

...
import com.hanmimei.activity.fragment.GoodsCommentFragment;
import com.hanmimei.activity.fragment.GoodsCommentFragment.EvaType;
...
public class GoodsCommentActivity extends BaseActivity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		BaseIconFragment picFragment = new GoodsCommentFragment(EvaType.picture,skuType,skuTypeId);

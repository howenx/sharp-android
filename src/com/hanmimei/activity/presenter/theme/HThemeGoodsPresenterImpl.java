...
public class HThemeGoodsPresenterImpl implements HThemeGoodsPresenter ,OnHThemeGoodsLoadListenter,OnCartNumListener{
	...
	/* (non-Javadoc)
	 * @see com.hanmimei.activity.goods.theme.presenter.HThemeGoodsPresenter#getHThemeGoodsData()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.hanmimei.activity.presenter.theme.HThemeGoodsPresenter#getCartNumData(java.util.Map, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.hanmimei.activity.goods.theme.model.HThemeGoodsModelImpl.OnHThemeGoodsLoadListenter#onSuccess(com.hanmimei.entity.HThemeGoods)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.hanmimei.activity.goods.theme.model.HThemeGoodsModelImpl.OnHThemeGoodsLoadListenter#onFailed(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.hanmimei.activity.model.theme.HThemeGoodsModelImpl.OnCartNumListener#onSuccess(java.lang.Integer)
	 */
	@Override

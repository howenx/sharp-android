...
public class ShoppingGoods implements Serializable {
	...
	private String skuType = "item";// 商品类型 1.vary,2.item,3.customize,4.pin
	...
	public ShoppingGoods(Long id, Integer cartId, Integer goodsId,
			String goodsImg, String goodsUrl, String goodsName,
			Double goodsPrice, Boolean isChecked, String state,
			Integer goodsNums, String itemColor, String itemSize,
			String shipFee, String delUrl, String invArea,
			Integer restrictAmount, Integer restAmount, Integer postalTaxRate,
			Integer postalStandard, Integer postalLimit, String invCustoms) {
		this.id = id;
		this.cartId = cartId;

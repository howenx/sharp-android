...
//	
	...
	//取消订单
	public static final String CANCLE_ORDER_URL = SERVERY1 + "/client/order/cancel/";
	//获取用户信息接口
	public static final String GET_USERINFO_URL = SERVERY4 + "/api/user/get/info";
	//获取订单列表接口
	public static final String GET_ORDER_LIST_URL = SERVERY1 + "/client/order";
	//订单是否过期（是否可以去支付）
	public static final String GET_ORDER_IS_TIME = SERVERY1 + "/client/order/verify/";
	//删除订单                
	...
	public static final String POST_CLIENT_ORDER_SUBMIT = SERVERY1 +"/client/order/submit";
	public static final String GOODS_DETAIL_URL = SERVERY3 +"/comm/detail/web/";
	public static final String CLIENT_PAY_ORDER_GET = SERVERY1 +"/client/pay/order/get/";
